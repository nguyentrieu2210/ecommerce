        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa bình luận của người dùng có tên là: <span class="text-danger">{{$comment->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên người dùng </label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($comment) ? $comment->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Nội dung </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($comment) ? $comment->content : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
            ...
            <div class="ibox-button">
                ...
                <a href="{{route('comment.index')}}" class="btn btn-white" >Quay lại</a>
            </div>
            </form>
        </div>
    </div>
