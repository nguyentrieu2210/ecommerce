...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('attribute.destroy', $attribute->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa thuộc tính có tên là: <span class="text-danger">{{$attribute->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên nhóm thuộc tính</label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($attribute) ? $attribute->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Mô tả </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($attribute) ? $attribute->description : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
