...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('attributeCatalogue.destroy', $attributeCatalogue->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa nhóm thuộc tính có tên là: <span class="text-danger">{{$attributeCatalogue->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên nhóm thuộc tính</label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($attributeCatalogue) ? $attributeCatalogue->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Mô tả </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($attributeCatalogue) ? $attributeCatalogue->description : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
