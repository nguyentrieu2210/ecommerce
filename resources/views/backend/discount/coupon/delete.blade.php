...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('coupon.destroy', $coupon->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa mã giảm giá là: <span class="text-danger">{{$coupon->code}}</span>
                    </p>
                    <p class="fs14">- Lưu ý: Không thể khôi phục dữ liệu sau khi xóa. Hãy chắc chắn rằng bạn muốn thực
                        hiện chức năng này</p>
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group"><label>Mã giảm giá </label> <input
                                    type="text" readonly value="{{ old('code') ?? (isset($coupon) ? $coupon->code : '') }}"
