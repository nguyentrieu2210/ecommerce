...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('slide.destroy', $slide->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa Slide có tên là: <span class="text-danger">{{$slide->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên Slide </label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($slide) ? $slide->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Từ khóa </label>
                                <input readonly type="text" 
                                    value="{{ old('keyword') ?? (isset($slide) ? $slide->keyword : '') }}" name="keyword"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
