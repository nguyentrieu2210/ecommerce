...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('warehouse.destroy', $warehouse->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa cơ sở có tên là: <span class="text-danger">{{$warehouse->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên cơ sở </label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($warehouse) ? $warehouse->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Mô tả </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($warehouse) ? $warehouse->description : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
