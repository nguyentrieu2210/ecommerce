        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa quyền có tên là: <span class="text-danger">{{$permission->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên quyền </label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($permission) ? $permission->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Canonical </label>
                                <input readonly type="text" 
                                    value="{{ old('canonical') ?? (isset($permission) ? $permission->canonical : '') }}" name="canonical"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
