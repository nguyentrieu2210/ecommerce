...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-lg-12">
            <form method="GET" action="{{route('userCatalogue.destroy', $userCatalogue->id)}}">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa nhóm thành viên có tên là: <span class="text-danger">{{$userCatalogue->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên nhóm </label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($userCatalogue) ? $userCatalogue->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Mô tả </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($userCatalogue) ? $userCatalogue->description : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
