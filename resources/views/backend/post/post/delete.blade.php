        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <p class="fs14">
                        - Bạn đang muốn xóa bài viết có tên là: <span class="text-danger">{{$post->name}}</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group"><label>Tên nhóm bài viết</label> <input
                                    type="text" readonly value="{{ old('name') ?? (isset($post) ? $post->name : '') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group"><label>Mô tả </label>
                                <input readonly type="text" 
                                    value="{{ old('description') ?? (isset($post) ? $post->description : '') }}" name="description"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
